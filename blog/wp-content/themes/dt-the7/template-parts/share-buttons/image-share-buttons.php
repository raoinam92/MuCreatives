<?php
/**
 * Template for image share buttons.
 *
 * @since   7.8.0
 *
 * @package The7
...
<div class="<?php echo esc_attr( $wrap_class ); ?>">
	...
	<div class="soc-ico">
		...
		foreach ( $share_buttons as $share_button ) {
			printf(
				'<a class="%1$s" href="%2$s" title="%3$s" target="_blank" %4$s><span class="soc-font-icon"></span><span class="screen-reader-text">%5$s</span></a>' . "\n",
