...
if ( ! class_exists( 'DT_Shortcode_Default_Button', false ) ) {
	...
	class DT_Shortcode_Default_Button extends DT_Shortcode_With_Inline_Css {
		...
		protected function get_less_vars() {
			...
			$less_vars->add_keyword( 'default-btn-border-color', $this->get_att( 'default_btn_border_color', '~""') );
			$less_vars->add_keyword( 'default-btn-border-color-hover', $this->get_att( 'default_btn_border_hover_color', '~""' ) );
			...
			if ( $this->get_att( 'size' ) === 'custom' ) {
				...
				$less_vars->add_pixel_number( 'default-btn-border-width', $this->get_att( 'border_width' ) );
