...
<div class="wc-coupon-wrap">
	<?php wc_print_notice( apply_filters( 'woocommerce_checkout_coupon_message', '<span class="showcoupon-tag"><i class="icomoon-the7-font-the7-tag-05" aria-hidden="true"></i>' . __( 'Have a coupon?', 'woocommerce' ) . '</span> <a href="#" class="showcoupon">' . __( 'Click here to enter your code', 'woocommerce' ) . '</a>' ), 'notice' ); ?>
